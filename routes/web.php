...
use App\Http\Controllers\Ent_DetailController;
...
Route::group(['middleware' => ['EntCheck']], function () {
    ...
    // display detail page
    Route::get('/ent/ent_detail', [Ent_DetailController::class, 'ent_detail'])->name('ent_detail');
...
Route::group(['middleware' => ['ApplicantsCheck']], function () {
    ...
    Route::get('/applicants/applicants_myjobs', [ApplicantsController::class, 'applicants_myjobs']);
});
